...
import com.pnj.storyapp.DataDummy
import com.pnj.storyapp.MainDispatcherRule
import com.pnj.storyapp.data.model.Story
import com.pnj.storyapp.data.repository.StoryRepository
import com.pnj.storyapp.getOrAwaitValue
...
class HomeViewModelTest {
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(storyRepository.getStories("test")).thenReturn(expectedStory)

        val homeViewModel = HomeViewModel(storyRepository)
        val actualStory: PagingData<Story> = homeViewModel.getStories("test").getOrAwaitValue()
    ...
    fun `when Get Quote Empty Should Return No Data`() = runTest {
        ...
        val actualStory: PagingData<Story> = mainViewModel.getStories("test").getOrAwaitValue()
